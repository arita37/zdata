...
###### Path ########################################################################
print( os.getcwd())
root2 = os.path.abspath(os.getcwd()).replace("\\", "/") + "/"
root = os.path.dirname(os.path.dirname(os.path.dirname( os.path.dirname( root2  ) )))   ### repo root
print("repo root", root,"\n")

sys.path.append(root)
print("package path", sys.path,"\n")

dir_data  = os.path.abspath( root + "/data/" ) + "/"
dir_data  = dir_data.replace("\\", "/")
print("data path", dir_data,"\n")
